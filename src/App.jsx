...
function MainLayout() {
  ...
  return (
    <div className="app-wrapper">
      {/* 3. The blurred background layer — now with a forest-green wash
          (see .blurred-background::after in App.css) so any photo reads
          as part of the same brand, instead of a plain dark overlay */}
      <div
        className="blurred-background"
        style={{ backgroundImage: `url(${currentBgImage})` }}
      ></div>
      ...
      {/* 4. The sharp foreground layer */}
      <div className="content-layer">
        <div className="d-flex flex-column flex-md-row justify-content-md-between align-items-center mb-4 border-bottom pb-3 gap-2 brand-header">
          <h2 className="m-auto text-center" style={{ color: "#fff" }}>
            Student Management System
          </h2>
        </div>
